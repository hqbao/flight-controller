...
#define TUNING_SCHEMA_VERSION 3
...
static param_storage_t default_storage[] = {
	...
	{.id=PARAM_ID_CTL_ATT_ROLL_P,         .value=4.0f},
	{.id=PARAM_ID_CTL_ATT_ROLL_I,         .value=1.0f},
	{.id=PARAM_ID_CTL_ATT_ROLL_D,         .value=2.0f},
	{.id=PARAM_ID_CTL_ATT_ROLL_I_LIMIT,   .value=5.0f},
	{.id=PARAM_ID_CTL_ATT_ROLL_P_LIMIT,   .value=1000000.0f},
	{.id=PARAM_ID_CTL_ATT_ROLL_O_LIMIT,   .value=1000000.0f},
	{.id=PARAM_ID_CTL_ATT_PITCH_P,        .value=4.0f},
	{.id=PARAM_ID_CTL_ATT_PITCH_I,        .value=1.0f},
	{.id=PARAM_ID_CTL_ATT_PITCH_D,        .value=2.0f},
	{.id=PARAM_ID_CTL_ATT_PITCH_I_LIMIT,  .value=5.0f},
	{.id=PARAM_ID_CTL_ATT_PITCH_P_LIMIT,  .value=1000000.0f},
	{.id=PARAM_ID_CTL_ATT_PITCH_O_LIMIT,  .value=1000000.0f},
	{.id=PARAM_ID_CTL_ATT_YAW_P,          .value=10.0f},
	{.id=PARAM_ID_CTL_ATT_YAW_I,          .value=1.0f},
	{.id=PARAM_ID_CTL_ATT_YAW_D,          .value=5.0f},
	{.id=PARAM_ID_CTL_ATT_YAW_I_LIMIT,    .value=5.0f},
	{.id=PARAM_ID_CTL_ATT_YAW_P_LIMIT,    .value=1000000.0f},
	{.id=PARAM_ID_CTL_ATT_YAW_O_LIMIT,    .value=1000000.0f},
	{.id=PARAM_ID_CTL_ATT_SMOOTH_INPUT,   .value=1.0f},
	{.id=PARAM_ID_CTL_ATT_SMOOTH_P_TERM,  .value=1.0f},
	{.id=PARAM_ID_CTL_ATT_SMOOTH_OUTPUT,  .value=1.0f},
	{.id=PARAM_ID_CTL_ATT_GAIN_TIME,      .value=1.0f},
	// Position Control — state_control outer loop
	{.id=PARAM_ID_CTL_POS_XY_P,            .value=100.0f},
	{.id=PARAM_ID_CTL_POS_Z_P,             .value=2000.0f},
	{.id=PARAM_ID_CTL_POS_VELOC_XY_SCALE,  .value=50.0f},
	{.id=PARAM_ID_CTL_POS_VELOC_Z_SCALE,   .value=2000.0f},
	{.id=PARAM_ID_CTL_POS_LPF_XY,          .value=1.0f},
	{.id=PARAM_ID_CTL_POS_LPF_Z,           .value=5.0f},
	{.id=PARAM_ID_CTL_POS_ANGLE_LIMIT,     .value=30.0f},
	{.id=PARAM_ID_CTL_POS_RC_DEADBAND,     .value=0.1f},
	// Motor/Servo
	...
	{.id=PARAM_ID_EST_Q_ACCEL,   .value=0.5f},
	{.id=PARAM_ID_EST_Q_GYRO,    .value=0.01f},
	{.id=PARAM_ID_EST_Q_BA,      .value=0.01f},
	{.id=PARAM_ID_EST_Q_BG,      .value=0.001f},
	{.id=PARAM_ID_EST_Q_BBARO,   .value=0.01f},
	// Estimator measurement noise (R diagonal)
	{.id=PARAM_ID_EST_R_ACCEL,    .value=1.0f},
	{.id=PARAM_ID_EST_R_MAG_YAW,  .value=0.1f},
	{.id=PARAM_ID_EST_R_BARO,     .value=1.0f},
	{.id=PARAM_ID_EST_R_LIDAR,    .value=0.05f},
	{.id=PARAM_ID_EST_R_OPTFLOW,  .value=0.1f},
	{.id=PARAM_ID_EST_R_GPS_POS_H, .value=1.0f},
	{.id=PARAM_ID_EST_R_GPS_POS_V, .value=2.0f},
	{.id=PARAM_ID_EST_R_GPS_VEL,   .value=0.3f},
	// Estimator gating + lever arms
	{.id=PARAM_ID_EST_CHI2_POS,    .value=11.34f},
	{.id=PARAM_ID_EST_CHI2_VEL,    .value=11.34f},
	{.id=PARAM_ID_EST_ACCEL_G_TOL, .value=1.5f},
	{.id=PARAM_ID_EST_GPS_LEVER_X, .value=0.0f},
	{.id=PARAM_ID_EST_GPS_LEVER_Y, .value=0.0f},
	{.id=PARAM_ID_EST_GPS_LEVER_Z, .value=0.0f},
	// FFT/Notch
