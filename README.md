...
A modular embedded flight control system for multi-rotor aircraft, written in **C** for the STM32H7 microcontroller. Integrates multiple sensors, performs real-time attitude and position estimation, and executes stabilization control loops.
