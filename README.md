...
│   ├── config/                    #   Runtime tuning parameters (65 params, flash-persistent)
...
│   ├── tuning_board.py            #   Parameter tuning GUI (65 params, query/upload/defaults)
...
| `tuning_board.py` | Parameter tuning GUI: 65 flash-persistent params in 7 categories, query/upload/defaults with confirmation |
