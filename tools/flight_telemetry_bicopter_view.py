...
def main():
    ...
    # =========================================================================
    ax_bic = fig.add_axes([0.10, 0.05, 0.85, 0.92], projection='3d')
    ax_bic.set_facecolor(BG_COLOR)
    ax_bic.view_init(elev=25, azim=-90)
    ...
    # =========================================================================
    # 3D view buttons — 6 face views, default = Back
    # =========================================================================
    view_btns = add_3d_view_buttons(
        fig, ax_bic, default='Back',
        rect=(0.12, 0.94, 0.045, 0.028), gap=0.003,
        color=PANEL_COLOR, hover=GRID_COLOR, text_color=TEXT_COLOR, fontsize=7,
    )
