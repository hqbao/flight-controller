...
TUNING_PARAMS = [
    ...
    (48,  'ctl_att_roll_p',         'Roll P',              4.0),
    (49,  'ctl_att_roll_i',         'Roll I',              1.0),
    (50,  'ctl_att_roll_d',         'Roll D',              2.0),
    (51,  'ctl_att_roll_i_limit',   'Roll I Limit',        5.0),
    (52,  'ctl_att_roll_p_limit',   'Roll P-Term Limit',   1000000.0),
    (53,  'ctl_att_roll_o_limit',   'Roll Output Limit',   1000000.0),
    (54,  'ctl_att_pitch_p',        'Pitch P',             4.0),
    (55,  'ctl_att_pitch_i',        'Pitch I',             1.0),
    (56,  'ctl_att_pitch_d',        'Pitch D',             2.0),
    (57,  'ctl_att_pitch_i_limit',  'Pitch I Limit',       5.0),
    (58,  'ctl_att_pitch_p_limit',  'Pitch P-Term Limit',  1000000.0),
    (59,  'ctl_att_pitch_o_limit',  'Pitch Output Limit',  1000000.0),
    (60,  'ctl_att_yaw_p',          'Yaw P',              10.0),
    (61,  'ctl_att_yaw_i',          'Yaw I',               1.0),
    (62,  'ctl_att_yaw_d',          'Yaw D',               5.0),
    (63,  'ctl_att_yaw_i_limit',    'Yaw I Limit',         5.0),
    (64,  'ctl_att_yaw_p_limit',    'Yaw P-Term Limit',    1000000.0),
    (65,  'ctl_att_yaw_o_limit',    'Yaw Output Limit',    1000000.0),
    (66,  'ctl_att_smooth_input',   'Smooth Input',        1.0),
    (67,  'ctl_att_smooth_p_term',  'Smooth P Term',       1.0),
    (68,  'ctl_att_smooth_output',  'Smooth Output',       1.0),
    (69,  'ctl_att_gain_time',      'Gain Ramp Time',      1.0),
    (70,  'ctl_pos_xy_p',           'XY P Gain',         100.0),
    (71,  'ctl_pos_z_p',            'Z P Gain',         2000.0),
    (72,  'ctl_pos_veloc_xy_s',     'XY Vel Scale',       50.0),
    (73,  'ctl_pos_veloc_z_s',      'Z Vel Scale',      2000.0),
    (74,  'ctl_pos_lpf_xy',         'XY LPF Alpha',        1.0),
    (75,  'ctl_pos_lpf_z',          'Z LPF Alpha',         5.0),
    (76,  'ctl_pos_angle_limit',    'Angle Limit (deg)',  30.0),
    (77,  'ctl_pos_rc_deadband',    'RC Deadband',         0.1),
    ...
    # --- ESKF Process Noise Q (IDs 83-87) ---
    (83,  'est_q_accel',        'Q Accel (m/s²/√Hz)',  0.5),
    (84,  'est_q_gyro',         'Q Gyro (rad/s/√Hz)',  0.01),
    (85,  'est_q_ba',           'Q Bias Accel',         0.01),
    (86,  'est_q_bg',           'Q Bias Gyro',         0.001),
    (87,  'est_q_bbaro',        'Q Bias Baro',          0.01),
    # --- ESKF Measurement Noise R (IDs 88-94) ---
    (88,  'est_r_accel',        'R Accel (m/s²)',       1.0),
    (89,  'est_r_mag_yaw',      'R Mag Yaw (rad)',       0.1),
    (90,  'est_r_baro',         'R Baro (m)',            1.0),
    (91,  'est_r_lidar',        'R Lidar (m)',          0.05),
    (92,  'est_r_optflow',      'R OptFlow (rad/s)',     0.1),
    (93,  'est_r_gps_pos_h',    'R GPS Pos Horiz (m)',   1.0),
    (94,  'est_r_gps_pos_v',    'R GPS Pos Vert (m)',    2.0),
    (95,  'est_r_gps_vel',      'R GPS Vel (m/s)',       0.3),
    # --- ESKF Innovation Gating (IDs 96-98) ---
    (96,  'est_chi2_pos',       'Chi² Pos Gate',       11.34),
    (97,  'est_chi2_vel',       'Chi² Vel Gate',       11.34),
    (98,  'est_accel_g_tol',    'Accel-G Tol (m/s²)',    1.5),
    # --- ESKF GPS Lever Arm (IDs 99-101) ---
    (99,  'est_gps_lever_x',    'GPS Lever X (m)',       0.0),
    (100, 'est_gps_lever_y',    'GPS Lever Y (m)',       0.0),
    (101, 'est_gps_lever_z',    'GPS Lever Z (m)',       0.0),
