...
"""
Position Estimation Chart (Z-Axis)

Time-series chart for Position Z (Altitude) and Velocity Z.
Useful for tuning altitude hold and checking barometer/laser fusion.
"""
