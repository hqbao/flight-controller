...
/* Platform drivers are in h7v1/platform/ — see platform_uart.c, platform_i2c.c, etc. */
...
int main(void)
{
  ...
  // Start UART DMA ring buffers (defined in platform/platform_uart.c)
  platform_hw_uart_start();
